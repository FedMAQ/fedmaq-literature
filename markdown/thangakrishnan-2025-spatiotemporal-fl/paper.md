...
$$
\begin{aligned}
\min _ { s _ { i } , m _ { i } } J _ { i } & = \omega _ { 1 } \sum _ { t = 1 } ^ { T } \lambda _ { t } P _ { \text {grid,} i t } + \omega _ { 2 } \sum _ { m \in A _ { i } } P _ { \text {penalty} } ^ { A _ { i , m } } - \omega _ { 3 } \max _ { i \in T } L _ { i t } \quad \text {volatility} \quad \text {volatility} \quad \text {volatility} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be} \quad \text {to be
\end{aligned}
$$
