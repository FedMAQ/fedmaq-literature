...
$$
\mathbb { E } ( t _ { i , k + 1 } ^ { r } ) = \mathbb { E } ( t _ { i , k + 1 } ^ { c p } + t _ { i , k + 1 } ^ { c m } ) \approx \mathbb { E } ( t _ { i , k + 1 } ^ { c p } ) + b _ { i , k + 1 } \times \mathbb { E } ( \frac { P } { r _ { i , k + 1 } ^ { t r a n s } } ) , \quad \text {As an} \quad \text {As} \quad \text {and} \quad \text {to} \quad \text
$$
