...
$$
\begin{aligned}
w _ { k } ^ { ( t + 1 ) } & = w _ { k } ^ { ( t ) } - \eta \nabla \mathcal { L } _ { k } \left ( w _ { k } ^ { ( t ) } \right ) \\ \dot { \cdot } & \cdot _ { 1 } \quad 1 \quad \dot { \cdot } \cdot _ { k } \cdot \quad \dot { \cdot } \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \cdot \quad \cdot \cdot \
\end{aligned}
$$
