...
$$
\begin{aligned}
\frac { 1 } { T } \sum _ { k = 0 } ^ { K - 1 } \sum _ { t = 0 } ^ { \tau - 1 } \mathbb { E } \| \nabla f ( \bar { x } _ { k , t } ) \| ^ { 2 } & \leq \mathcal { O } \left ( \frac { 1 } { \sqrt { T } } \right ) + \mathcal { O } \left ( \frac { \tau - 1 } { T } \right ) . \\ \text {Clearly, the fastest convergence rate is achieved for the} & \quad \ \end{aligned}
$$
