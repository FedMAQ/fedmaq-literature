...
description: "Renewable Energy Communities (RECs) with *dynamic portfolios* (daily member composition changes) produce electrical load time series that are simultaneously:"
authors: "Richter et al."
year: 2024
bibkey: richter-2024-electric-load
tags: [application]
resource: markdown/richter-2024-electric-load/paper.md
timestamp: 2026-06-21T13:35:34Z
---
...
[1] Full-text conversion: [markdown/richter-2024-electric-load/paper.md](markdown/richter-2024-electric-load/paper.md)
[2] Source PDF: `papers/05 Applications/Richter et al. - 2024 - Advancing Electric Load Forecasting Leveraging Federated Learning for Distributed, Non-Stationary,.pdf`
