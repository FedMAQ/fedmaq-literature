...
description: "Short-term energy consumption forecasting in smart grids faces three key challenges: (i) privacy concerns from aggregating sensitive household consumption data centrally, (ii) scalability issues when thousands of..."
authors: "Abdulla et al."
year: 2024
bibkey: abdulla-2024-smart-meter
tags: [application]
resource: markdown/abdulla-2024-smart-meter/paper.md
timestamp: 2026-06-21T08:32:58Z
---
...
[1] Full-text conversion: [markdown/abdulla-2024-smart-meter/paper.md](markdown/abdulla-2024-smart-meter/paper.md)
[2] Source PDF: `papers/05 Applications/Abdulla et al. - 2024 - Smart meter-based energy consumption forecasting for smart cities using adaptive federated learning.pdf`
