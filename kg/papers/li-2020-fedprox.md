...
description: "Federated learning (FL) suffers from two key challenges: (i) systems heterogeneity – devices have varying computational, communication, and energy capabilities; (ii) statistical heterogeneity – data across devices is..."
authors: "Li et al."
year: 2020
bibkey: li-2020-fedprox
baseline: FedProx
tags: [fl-core, vanilla]
resource: markdown/li-2020-fedprox/paper.md
timestamp: 2026-06-21T04:29:18Z
---
...
[1] Full-text conversion: [markdown/li-2020-fedprox/paper.md](markdown/li-2020-fedprox/paper.md)
[2] Source PDF: `papers/01 FL, Heterogeneity/Li et al. - 2020 - Federated Optimization in Heterogeneous Networks.pdf`
