...
description: "Anomaly detection in IoT-enabled smart buildings (e.g., lighting faults, energy consumption prediction) is traditionally performed using centralized machine learning models."
authors: "Sater and Hamza"
year: 2021
bibkey: sater-2021-anomaly-detection
tags: [application]
resource: markdown/sater-2021-anomaly-detection/paper.md
timestamp: 2026-06-21T09:09:56Z
---
...
- **Technique Integration (Knowledge Distillation):** The paper uses a stacked LSTM (teacher model). [FedMAQ](/methods/fedmaq.md)'s **Knowledge Distillation (KD)** technique could be applied to train a smaller, more efficient student model (e.g., a single-layer GRU) — server-side only, following FedMAQ's design, where clients train no local teacher. The student model would learn to mimic the ensemble output distribution of the participating clients' larger FSLSTM models, allowing for a smaller model to be deployed on resource-constrained sensors, further reducing communication and computation costs.
...
[1] Full-text conversion: [markdown/sater-2021-anomaly-detection/paper.md](markdown/sater-2021-anomaly-detection/paper.md)
[2] Source PDF: `papers/05 Applications/Sater and Hamza - 2021 - A Federated Learning Approach to Anomaly Detection in Smart Buildings.pdf`
