...
description: "Traditional parameter-based Federated Learning (FL) suffers from several long-lasting challenges: privacy risks from sharing model parameters, performance degradation under non-IID (heterogeneous) data distributions,..."
authors: "Qin et al."
year: 2025
bibkey: qin-2025-kd-survey
tags: [survey, kd]
resource: markdown/qin-2025-kd-survey/paper.md
timestamp: 2026-06-21T08:31:10Z
---
...
[1] Full-text conversion: [markdown/qin-2025-kd-survey/paper.md](markdown/qin-2025-kd-survey/paper.md)
[2] Source PDF: `papers/00 Surveys/Qin et al. - 2025 - Knowledge Distillation in Federated Learning A Survey on Long Lasting Challenges and New Solutions.pdf`
